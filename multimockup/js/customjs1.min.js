$(document).ready(function() {
    ...
    $('.iphone-wrapper, .ipad-wrapper, .desktop-wrapper, desktop-wrapper-logo, .mac-wrapper').draggable({
        //revert: true,
        zIndex: 100,
    ...
    $("[name='imaclogo']").change(function() {
        if($(this).is(":checked")) {
            $('.desktop-wrapper-logo').fadeIn('slow');
        } else {
            $('.desktop-wrapper-logo').fadeOut('slow');
        }
    });
    ...
    $("[name='largermockups']").change(function() {
        if($(this).is(":checked")) {
            ...
            $('.desktop-wrapper-logo').animate({'scale' : '1.2'}, "slow");
            ...
            $('.desktop-wrapper-logo').animate({'scale' : '1'}, "slow");
			$('.desktop-wrapper-logo').fadeOut("fast");
            $('.desktop-wrapper-logo').fadeIn("fast");
        }
    });
